...
{
    public class NewOrderItemDtoValidator : AbstractValidator<NewOrderItemDto>
    {
        public NewOrderItemDtoValidator(string httpMethod, Dictionary<string, object> passedPropertyValuePaires)
        {
